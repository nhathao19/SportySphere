...
<section class="home">
    ...
    <div class="content">
        <h3>Unleash Your Potential <hr> Every Step Counts</h3>
        <p>Lorem ipsum dolor sit amet consctetur adipisicing elit. Excepturi, quod? Reiciendis ut porro iste totam.</p>
...
<section class="products">
    ...
    <div class="box-container">
        ...
        <?php
            ...
            if ($select_products === false) {
                error_log('Query failed: ' . mysqli_error($conn));
                echo '<p class="error">An error occurred while fetching products.</p>';
            } else if ($select_products->num_rows > 0) {
